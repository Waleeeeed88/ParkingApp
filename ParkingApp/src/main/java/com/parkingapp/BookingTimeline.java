...
public class BookingTimeline extends JFrame {
    ...
    public static class TimelinePanel extends JPanel {
        ...
        private void handleClick(MouseEvent e) {
            ...
            // (For testing, we’re not blocking past time slots.)
        ...
        // New confirmSelection method that returns the selected time range via the listener
        public void confirmSelection() {
            ...
            // Optionally clear the selection after confirmation
            selectedStartSegment = -1;
            selectedEndSegment = -1;
            repaint();
        }
