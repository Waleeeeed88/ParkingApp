...
import java.util.Objects; // Added for Objects.hash in the inner Booking class if needed, but should use external one
...
import com.parkingapp.GUI.BookingPageGUI;
